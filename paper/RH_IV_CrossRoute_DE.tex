...
% =============================================================================
\section{Update (v3.2): Der RH/abc-Archimedische-Masse-Crosswalk}
\label{sec:v32-abc}
% =============================================================================

Eine problemübergreifende Linie, die informell neben den Routen dieser
Serie mitgeführt wurde, wurde zwischen Juni und August 2026 zum Abschluss
auditiert. Sie wird hier in Teil~IV dokumentiert und nicht beim spektralen
Material von Teil~III~\cite{Geiger2026partIII}, weil sie eine Brücke
zwischen RH und einer zweiten Vermutung betrifft und keine Route innerhalb
der RH-Landschaft selbst.

Der Crosswalk (Registerbezeichnung~B2, Stand~V1.1) verglich die
archimedischen Masseobjekte beider Seiten: auf der RH-Seite $\mu_-$, eine
signierte dimensionslose Negativmasse, gegen auf der abc-Seite $\Omega_E$,
eine positive N\'eron-Periode. Bestätigt ist allein eine strukturelle
Analogie --- die beiden sind keine Instanzen eines gemeinsamen Objekts, und
es ergab sich keine gemeinsame Normalisierung, unter der sie quantitativ
vergleichbar wären. Ein begleitendes Kandidaten-Audit prüfte vier
Vorschläge für ein solches gemeinsames Objekt, nämlich den
Connes--Consani-Trace, die Yuan--Zhang-Höhenpaarung, die
Frey-Perioden-Loghöhe und einen formalen Container, und stellte fest, dass
keiner von ihnen die vier Brückenpflichten erfüllt. Das Audit stützt sich
auf fünf gebundene Quellen mit Produzenten- und Prüferquoten von je
$19/19$, fail-closed. Die Folge für die Landschaft ist, dass die Brücke
RH\,$\leftrightarrow$\,abc \emph{als Sprachanalogie} erschöpft ist: Ein
Nachfolger müsste ein normalisiertes gemeinsames $H_\infty$ mit typisiertem
Träger, beiden Realisierungen, kompatiblen Normalisierungen und zwei
nichtzirkulären Ungleichungen liefern. Claim-Grenze: Geschlossen wird hier
die geprüfte Kandidatenliste und die Analogielesart der Brücke --- keine
der beiden Vermutungen wird widerlegt, und ein Objekt außerhalb der vier
geprüften Kandidaten ist ungeprüft, nicht ausgeschlossen.
