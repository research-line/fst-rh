...
$\kappa_\infty \in [1.6,1.8]\times 10^{-3}$ for Branch~B,
...
B (Hadamard) & $\kappa_\infty \in [1.6,1.8]\times 10^{-3}$ & saturates with $\lambda$ & finite-part residual curvature of Foundation-Lock \\
