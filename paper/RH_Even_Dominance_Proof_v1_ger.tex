...
\begin{itemize}[leftmargin=*]
  ...
  \item \emph{Interne offene Frage:} Approximationsqualitaet $k_\Lambda\approx\xi_\Lambda$ (Connes 2026 §6.6 ``remaining steps'' item~(ii)) --- das ist die Massen-Konzentrations-Frage MS2, adressiert im Begleit-Paper Zookeeper \cite{GeigerZookeeper2026}.
\end{itemize}
