...
\begin{proposition}[Direkte Frontier-Dominanz]
\label{prop:direct-frontier}
Für alle $\lambda \geq 100$ gilt $\lambda_{\min}(D_{\mathrm{total}}(\lambda)) < 0$.
\end{proposition}
