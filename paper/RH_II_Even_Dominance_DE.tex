...
\begin{itemize}
  ...
  \item \textbf{v2.1 Direkter Frontier-Dominanz-Beweis} (\Cref{prop:direct-frontier}, \Cref{sec:direct-frontier}): verwendet einen gemeinsamen Rayleigh-Testvektor auf $r\in[0.7,1]$, PNT-partielle Summation, Mertens' Satz, die Variations-Ungleichung und endliche CAP-Abdeckung bis zur expliziten asymptotischen Schwelle. Beide v2.0-Vorbehalte werden obsolet (\Cref{rem:direct-proof-ingredients}).
\end{itemize}
Zusammen mit Connes' Satz~6.1 (A1), Hurwitz-Suffzienz (A2), dem Shift-Parity-Lemma (A4) und dem Frontier-Primzahl-Mechanismus (A5) ist die Beweisarchitektur~A1--A8 für die Riemann-Hypothese vollständig und unbedingt. Alle Schritte sind entweder extern etablierte Ergebnisse (A1, A2), computergestützte Zertifikate für die endliche Brücke (A3) oder analytische Beweise in diesem Papier (A4, A5, A6 via Direkter Frontier-Dominanz).
