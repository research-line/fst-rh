...
\begin{proposition}[Direct Frontier-Dominance]
\label{prop:direct-frontier}
For all $\lambda \geq 100$, $\lambda_{\min}(D_{\mathrm{total}}(\lambda)) < 0$.
\end{proposition}
